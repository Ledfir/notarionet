...
<body>
	...
	<hr class="hr_1">
		...
		Hola <b>{{ $inputs['name'] }}</b><br>
        NOTARIONET requiere validar tu cuenta de correo para evitar usuarios falsos.<br>
		Ingresa al siguiente link para comfirmar tu correo electronico<br><br>
		
        <b>https://notarionet.com/#/confirmar/{{ $inputs['id']}}</b><br><br>

...
<body>
	...
	<hr class="hr_1">
		...
		El documento con ID <b>NN000{{ $inputs['order_id'] }}</b> llamado; <b>{{ $inputs['contract']['title'] }}</b> ha sido firmado con sello digital y sello de tiempo.<br>
		Puedes consultarlo en el pdf adjunto.<br><br>
